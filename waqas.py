...
def login():
	os.system('clear')
	print logo
	print "\033[1;36;40mlogin Facebook"
        time.sleep(0.05)
        print "[\033[1;36;40mLogin With Token"
        time.sleep(0.05)
        print "\033[1;36;40mDownload Token App"
        time.sleep(0.05)
	pilih_login()

def pilih_login():
	peak = raw_input("\n\033[1;95m[+] \033[0;31mSelect Option: \033[1;91m")
	if peak =="":
...
def login1():
	...
	try:
		...
		os.system('clear')
                time.sleep(0.05)
		print logo                
		print "\033[1;95m•-----------------\033[1;35mWAQAS\033[1;97m-----------------•"
		print('\033[1;95m[+]\033[1;47m\033[1;31mLOGIN WITH FACEBOOK' )
		print('	' )
		id = raw_input('\033[1;91m[1] \x1b[1;95mNumber/Email')
		pwd = raw_input('\033[1;91m[2] \x1b[1;95mPassword')
		tik()
		try:
